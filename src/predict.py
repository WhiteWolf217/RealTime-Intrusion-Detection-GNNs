...
import sys
import os
from src.model import EdgeClassifier
from torch_geometric.data import Data
from src.pcap_processor import pcap_to_flows
...
def prepare_graph_data(df):
    if df is None or df.empty:
        raise ValueError("Input DataFrame is empty or None. No packets were captured or parsed.")
